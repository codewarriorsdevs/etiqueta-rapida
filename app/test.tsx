...
const  loadingPrinters = async()=>{
 const printers = await printerService.lookingForPrinter();
 if(printers){
  return printers;
 }
 else{
  return "sem impressoras";
 }
}
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>mude  uma impressora da lista para continuar.</Text>
      </View>
      ...
      >
        {isConnecting ? (
          ...
          <Text style={styles.actionButtonText}>nai</Text>
        )}
      </TouchableOpacity>
    </View>
  );
